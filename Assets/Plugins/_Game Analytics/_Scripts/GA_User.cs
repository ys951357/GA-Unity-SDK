...
public static class GA_User
{
	public enum Gender { Unknown, Male, Female }
	
	#region public methods
	
	public static void NewUser(Gender gender, int? birth_year, string country, string state, int? friend_count)
	{
		CreateNewUser(gender, birth_year, country, state, friend_count);
	}
	...
	/// </param>
	private static void CreateNewUser(Gender gender, int? birth_year, string country, string state, int? friend_count)
	{
		...
		{
			parameters.Add(GA_ServerFieldTypes.Fields[GA_ServerFieldTypes.FieldType.Country], country);
		}
		
		if (state != null && state != "")
		{
			parameters.Add(GA_ServerFieldTypes.Fields[GA_ServerFieldTypes.FieldType.State], state);
		}
